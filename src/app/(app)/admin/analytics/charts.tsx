    ...
    return (
         <Card>
            <CardHeader>
                ...
                <CardDescription>Current stage of all submissions platform-wide.</CardDescription>
            </CardHeader>
...
export const GlobalTasksByCompanyChart = ({ tasks, companies }: { tasks: Task[], companies: Company[] }) => {
    const chartData = useMemo(() => {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Number of tasks each company has posted.</CardDescription>
            </CardHeader>
            <CardContent>
...
export const GlobalCriteriaRadarChart = ({ evaluations }: { evaluations: Evaluation[] }) => {
    const chartData = useMemo(() => {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Platform-wide average scores for each evaluation area.</CardDescription>
            </CardHeader>
...
export const GlobalSubmissionTrendChart = ({ submissions }: { submissions: Submission[] }) => {
    const chartData = useMemo(() => {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Volume of submissions over the past month.</CardDescription>
            </CardHeader>
            <CardContent>
                <ChartContainer config={chartConfig}>
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Leaderboard of the highest-scoring candidates across all tasks.</CardDescription>
            </CardHeader>
            <CardContent>
                <Table>
                    <TableHeader>
