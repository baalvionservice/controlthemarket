...
const formSchema = z.object({
  criteriaScores: z.object(
    allCriteria.reduce((acc, key) => {
      acc[key] = z.number().min(0).max(10).default(0);
      return acc;
...
export function OverrideForm({ submission }: { submission: SubmissionWithRelations }) {
        ...
        <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea placeholder="Admin comments or override reason..." className="min-h-[120px]" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
