...
export function ProfileForm({ user, onUpdate }: ProfileFormProps) {
  ...
  function onSubmit(values: z.infer<typeof profileFormSchema>) {
    const updatedSkills = values.skills?.split(',').map(s => s.trim()).filter(Boolean);
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <div className="flex items-center gap-6">
            ...
            <div className="grid gap-1.5">
                <p className="text-sm text-muted-foreground">Update your profile picture on Gravatar.</p>
                <Button type="button" variant="outline">Change Avatar (Mock)</Button>
            </div>
        </div>
        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl><Textarea placeholder="Tell us a little bit about yourself" className="resize-y" {...field} /></FormControl>
                    <FormMessage />
                </FormItem>
            )}
        />
             ...
             <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl><Input placeholder="React, Node.js, Figma, etc." {...field} /></FormControl>
