...
import { Bar, BarChart, CartesianGrid, XAxis, Pie, PieChart, Cell, Line, LineChart, YAxis } from 'recharts';
import {
  Card,
  CardContent,
  CardDescription,
...
const StatusDistributionChart = ({ submissions }: { submissions: Submission[] }) => {
    const statusConfig = {
    ...
    return (
         <Card>
            <CardHeader>
                ...
                <CardDescription>Current stage of all candidates in the pipeline.</CardDescription>
            </CardHeader>
        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Not enough data to display score trends over time.</CardDescription>
                </CardHeader>
                 <CardContent className="flex items-center justify-center h-48">
                    <p className="text-sm text-muted-foreground">Requires at least 2 evaluations.</p>
                 </CardContent>
            </Card>
        )
    }
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Shows the scores of evaluations over time.</CardDescription>
            </CardHeader>
            <CardContent>
                <ChartContainer config={chartConfig}>
                    <LineChart
...
// --- Main Components ---
export function AnalyticsCharts({ submissions, evaluations }: AnalyticsChartsProps) {
  return (
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Leaderboard of the highest-scoring candidates.</CardDescription>
            </CardHeader>
            <CardContent>
                <Table>
                    <TableHeader>
