...
const formSchema = z.object({
  ...
  summaryFeedback: z.string().min(10, { message: 'Summary feedback must be at least 10 characters long.' }),
});
...
export function FeedbackForm({ evaluation }: { evaluation: Evaluation }) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      criteriaComments: evaluation.criteriaComments || allCriteria.reduce((acc, key) => ({...acc, [key]: ''}), {}),
         ...
         <Card>
            ...
            <CardContent>
                 <FormField
                    ...
                    <FormItem>
                        <FormControl>
                        <Textarea placeholder="Provide constructive, high-level feedback for the candidate..." className="min-h-[150px]" {...field} />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                    )}
