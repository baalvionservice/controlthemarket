                                ...
                                <TableRow key={member.id}>
                                    ...
                                    <TableCell>
                                        <Select
                                            ...
                                            onValueChange={(newRole) => handleRoleChange(member.id, newRole as CompanyRole)}
                                    ...
                                    <TableCell className="text-right">
                                        <DropdownMenu>
                                            <DropdownMenuTrigger asChild>
                                                <Button variant="ghost" size="icon" disabled={member.companyRole === 'owner'}>
            ...
            <Dialog open={isInviteOpen} onOpenChange={setIsInviteOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Enter the email address and role for the new team member. They will receive an email to join your team.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4 py-4">
                        <div className="space-y-2">
                            <Label htmlFor="email">Email Address</Label>
                            <Input id="email" type="email" placeholder="name@example.com" value={emailToInvite} onChange={e => setEmailToInvite(e.target.value)} />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="role">Role</Label>
                            <Select value={roleToInvite} onValueChange={value => setRoleToInvite(value as CompanyRole)}>
                                <SelectTrigger>
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                    {companyRoles.filter(r => r !== 'owner').map(role => (
