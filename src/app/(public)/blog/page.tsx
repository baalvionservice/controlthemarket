    ...
    script.innerHTML = `
      ...
      const ARTICLES = {
        ...
        'skill-gaps': {
          ...
          body:\`
            <h2>The Skills Gap Is Real — And Growing</h2>
        ...
        'hire-developers': {
          ...
          body:\`
            <h2>The Developer Hiring Crisis</h2>
        ...
        'vs-job-boards': {
          ...
          body:\`
            <h2>The Job Board Model Is Built on Volume, Not Quality</h2>
        ...
        'ai-skill-matching': {
          ...
          body:\`
            <h2>The AI That Powers SkillMatch Pro</h2>
        ...
        'future-talent': {
          ...
          body:\`
            <h2>The Remote Revolution and Its Talent Problem</h2>
        ...
        'how-corporates-hire-smarter': {
            ...
            body:\`
                <h2>The Corporate Hiring Paradox: More Data, Less Clarity</h2>
        ...
        'secure-online-exams': {
            ...
            body:\`
                <h2>The Challenge of Modern Education: Scale, Security, and Credibility</h2>
        ...
        'streamline-candidate-screening': {
            ...
            body:\`
                <h2>The Agency Grind: Repetitive Work, Eroding Margins</h2>
        ...
        'scaling-national-skill-programs': {
            ...
            body:\`
                <h2>The Unique Challenges of Government Skill Initiatives</h2>
          ...
          <div class="post-card" onclick="openArticle('${p.id}')">
            ...
            <div class="post-card-body">
              ...
              <div style="display:flex;justify-content:space-between;align-items:center">
                <div class="post-tags">\${p.tags.slice(0,2).map(t=>\`<span class="ptag">\${t}</span>\`).join('')}</div>
