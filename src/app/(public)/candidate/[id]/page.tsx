  ...
  return (
    <div className="flex-1 bg-muted/20 pb-20">
      ...
      <div className="relative h-48 w-full bg-muted">
        <Image src={`https://picsum.photos/seed/${candidate.id}/1200/300`} alt={`${candidate.name}'s banner`} layout="fill" objectFit="cover" />
          ...
          <div className="lg:col-span-1 space-y-8">
            <Card className="overflow-hidden text-center">
              <CardContent className="p-6 pt-12">
                ...
                <div className="mt-4 flex justify-center gap-2">
                  {candidate.profile?.githubUrl && <Button asChild variant="outline" size="icon"><Link href={candidate.profile.githubUrl} target="_blank"><Github className="h-5 w-5" /></Link></Button>}
                  {candidate.profile?.linkedinUrl && <Button asChild variant="outline" size="icon"><Link href={candidate.profile.linkedinUrl} target="_blank"><Linkedin className="h-5 w-5" /></Link></Button>}
                  {candidate.profile?.portfolioLinks?.[0] && <Button asChild variant="outline" size="icon"><Link href={candidate.profile.portfolioLinks[0]} target="_blank"><Globe className="h-5 w-5" /></Link></Button>}
            ...
            <Card>
              ...
              <CardContent className="flex flex-col gap-4">
                {candidate.profile?.badgeIds && candidate.profile.badgeIds.length > 0 ? (
            ...
            <Card>
              ...
              <CardContent className="flex flex-wrap gap-2">
                {candidate.profile?.experienceLevel && <Badge variant="secondary" className="text-base">{candidate.profile.experienceLevel}</Badge>}
