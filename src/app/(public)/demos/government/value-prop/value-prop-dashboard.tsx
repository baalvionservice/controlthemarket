...
interface ValuePropositionData {
  live_assessments: { candidate: string; program: string; assessment: string; status: string; score: number; video_url: string; }[];
  dashboard_stats: {
        ...
        <div className="space-y-8 mt-8">
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{data.dashboard_stats.assessments_completed.toLocaleString()}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-8">
                     <Card>
                        <CardHeader>
                            <CardTitle>Live Candidate Assessments</CardTitle>
                            <CardDescription>Monitor candidate progress and review recorded sessions for auditing.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Table>
                                <TableHeader>
                                ...
                                <TableBody>
                                    ...
                                    <TableRow key={assessment.candidate}>
                                        <TableCell className="font-medium">{assessment.candidate}<br/><span className="text-xs text-muted-foreground">{assessment.program}</span></TableCell>
                    ...
                    <Card>
                     ...
                     <Card>
                        ...
                        <CardContent className="space-y-2 text-xs font-mono bg-muted p-4 rounded-md">
                            <p><span className="font-bold text-green-600">GET</span> /api/government_programs/&#123;id&#125;/assessments</p>
                            <p><span className="font-bold text-green-600">GET</span> /api/government_programs/&#123;id&#125;/analytics</p>
                        </CardContent>
                    </Card>
                </div>
            </div>
