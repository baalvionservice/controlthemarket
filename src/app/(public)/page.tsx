...
const ShopifyLogo = () => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-7 w-auto text-muted-foreground">
    <title>Shopify</title>
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="container py-12">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-x-8 gap-y-6 md:gap-x-12 lg:gap-x-16">
              <ShopifyLogo />
              <DecathlonLogo />
              <BookingLogo />
              <PGLogo />
